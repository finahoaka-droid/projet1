...
<head>
    ...
    <title>Modifier un Paramètre</title>
...
<body>
    <div class="container main-container">
        ...
        <div class="form-container">
            ...
            <form action="<c:url value='/parametres/update'/>" method="post">
                <input type="hidden" name="id" value="${parametre.idParametre}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="idMatiere" name="idMatiere" 
                           value="${parametre.idMatiere}" required min="1">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="difference" name="difference" 
                           value="${parametre.difference}" required step="0.01" min="0" placeholder="ex: 3.00">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="idOperateur" name="idOperateur" 
                           value="${parametre.idOperateur}" required min="1">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="idResolution" name="idResolution" 
                           value="${parametre.idResolution}" required min="1">
