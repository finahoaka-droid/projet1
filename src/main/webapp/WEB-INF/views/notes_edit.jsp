...
<body>
    <div class="container main-container">
        ...
        <div class="form-container">
            ...
            <form action="<c:url value='/notes/update'/>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="idCandidat" name="idCandidat" 
                           value="${note.idCandidat}" required min="1">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="idMatiere" name="idMatiere" 
                           value="${note.idMatiere}" required min="1">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="idCorrecteur" name="idCorrecteur" 
                           value="${note.idCorrecteur}" required min="1">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="note" name="note" 
                           value="${note.note}" required step="0.01" min="0" max="20" placeholder="ex: 15.50">
